...
rsimilar(rng::CuArrays.CURAND.RNG, f!, x::CuArray, dims::Int...) = _rsimilar(rng, f!, x, dims...)
rsimilar(::AbstractRNG, f!, x::CuArray, dims::Int...) = _rsimilar(CuArrays.CURAND.generator(), f!, x, dims...)
